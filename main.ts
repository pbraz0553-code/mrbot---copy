namespace SpriteKind {
    ...
    export const VidaExtra = SpriteKind.create()
}
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.VidaExtra, function (sprite, otherSprite) {
    info.changeLifeBy(1)
...
let sr_robot: Sprite = null
// ===================================
// MENU INICIAL (tela de inicio)
// ===================================
game.splash("SR ROBOT", "APERTE A PARA COMEÇAR")
...
sr_robot = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(sr_robot, 100, 0)
controller.moveSprite(sr_robot)
...
scene.cameraFollowSprite(sr_robot)
sr_robot.ay = 300
for (let value of tiles.getTilesByType(assets.tile`myTile`)) {
    ...
    for (let value of tiles.getTilesByType(assets.tile`moeda`)) {
        ...
        tiles.placeOnTile(Score, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
        for (let value of tiles.getTilesByType(assets.tile`vida`)) {
